...
[ -z "$SAVE_PATH" ] && SAVE_PATH=results/theodore_plus_persp
#[ -z "$DATASET" ] && DATASET=/mnt/data/seuj/theodore_plus/splits_symlinks/seed_20200805__numimgs_0062500__train_80__valid_10__test_10/perspective

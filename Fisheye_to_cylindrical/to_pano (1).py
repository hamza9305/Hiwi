...
def run(args):
    ...
    for input_file in input_files:
        ...
        dim = (w, h)
        # resize image
        resized = cv2.resize(img_cyl, dim, interpolation = cv2.INTER_LINEAR)
...
def main():
    try:
        opts, args = getopt.getopt(sys.argv[1:], "i:o:w:h:f:av", ["help", "indir=", "outdir=", "width=", "height=", "aux", "verbose"])
